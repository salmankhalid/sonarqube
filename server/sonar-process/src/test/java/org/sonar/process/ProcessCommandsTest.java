...
public class ProcessCommandsTest {
  ...
  public void child_process_update_the_mapped_memory() throws Exception {
    ...
    assertThat(commands.mappedByteBuffer.getLong(1 + commands.offset())).isEqualTo(0L);
    ...
    commands.ping();
    assertThat(commands.mappedByteBuffer.getLong(1 + commands.offset())).isGreaterThanOrEqualTo(currentTime);
  }
  ...
  public void ask_for_stop() throws Exception {
    ...
    ProcessCommands commands = new ProcessCommands(dir, 1);
    assertThat(commands.mappedByteBuffer.get(0)).isNotEqualTo(ProcessCommands.STOP);
